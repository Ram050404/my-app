...
const StudentPage = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <div className=" bg-sky-950 p-6 w-64 hidden md:block border-r overflow-y-auto">
        <div className="flex items-center mb-8">
          <FaUserCircle className="text-sky-100 mr-2" size={24} />
          <span className="text-sky-100 font-bold">{name}</span>
        </div>
        <nav className="space-y-4">
          <Link to="/student/dashboard" className="flex items-center text-sky-200 hover:text-white">
            <FaGraduationCap className="mr-2" />
            Home Page
          </Link>
          <Link to="/student/applications" className="flex items-center text-sky-200 hover:text-white">
            <FaUserTie className="mr-2" />
            My Applications
          </Link>
          <Link to="/student/partner-selection" className="flex items-center text-sky-200 hover:text-white">
            <FaChalkboardTeacher className="mr-2" />
            Partner Selection
          </Link>
          <Link to="/student/graduation-theme" className="flex items-center text-sky-200 hover:text-white">
            <FaGraduationCap className="mr-2" />
            Graduation Theme
          </Link>
        </nav>
